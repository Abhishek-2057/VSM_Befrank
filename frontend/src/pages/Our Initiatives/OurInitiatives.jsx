...
export const OurInitiative = () => {
    ...
    return (
      <div className="bg-white">
        <SEO
          title="Our Initiatives | Be Frank Programs for Student Growth & Expression"
          description="Explore Be Frank initiatives like School Chale Hum, Mehfil, Book Bite, and Vawsomes Blog that nurture creativity and confidence among students."
          keywords="Be Frank initiatives, School Chale Hum, Mehfil VSM, student creativity programs"
          url="https://befrank.vsmthane.org/our-initiatives"
        />
