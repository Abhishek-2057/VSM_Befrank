    ...
    <div className="bg-gradient-to-br from-gray-50 to-blue-50/30 min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-[#2692d1] to-[#f48321] bg-clip-text text-transparent mb-2">
              Our Events
            </h1>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 bg-[#2692d1] hover:bg-[#1e7bb8] text-white rounded-lg shadow-md transition-all duration-200"
          >
        ...
        <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-lg mb-8 border border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 items-end">
            ...
            <div>
              <label className="text-sm font-semibold text-gray-700 mb-2 block flex items-center">
                <CalendarDays size={16} className="mr-1.5 text-[#f48321]" /> End
                Date
              </label>
              <input
                type="date"
